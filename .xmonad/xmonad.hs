-- Slightly modified from xmonad config used by Vic Fryzel
-- See: http://github.com/vicfryzel/xmonad-config
...
--
myWorkspaces    = ["1:code","2:web","3:msg","4:proc","5:media","6","7","8","9"]
